...
export const roundMovies: ICategory[] = [
	{
		id: "1qxjjd4k1scs3a1",
		name: "Star Wars and Marvel",
		answers: [
			{
				id: "1qxjjd4k1scs3a6",
				type: AnswerType.TEXT,
				answer: "This is the name of the new Avengers movie",
			...
			},
			{
				id: "1qxjjd4k1scs3ag",
				type: AnswerType.TEXT,
				answer: "This is the name of Han Solo's ship",
			...
			},
			{
				id: "1qxjjd4k1scs3aq",
				type: AnswerType.TEXT,
				answer: "Here Iron Man fought Whiplash for the first time",
		...
		answers: [
			{
				id: "1qxjjd4k1scs3a7",
				type: AnswerType.TEXT,
				answer: "This animated feature film was Pixar's first release in 1995",
			...
			},
			{
				id: "1qxjjd4k1scs3ac",
				type: AnswerType.TEXT,
				answer: 'The movie "WALL-E" features a robot of the same name. This is his job.',
				answerDe: 'Der Film "WALL-E" zeigt einen gleichnamigen Roboter. Das ist sein Job.',
				question: "Trash Collector",
				explanation: "",
				points: 400,
				show: false,
				answered: false
		...
		answers: [
			{
				id: "1qxjj0ek1sccaij",
				type: AnswerType.TEXT,
				answer: "A cartoon about a sponge in the ocean.",
				answerDe: "Ein Cartoon über einen Schwamm im Meer.",
				question: "What is SpongeBob SquarePants?",
				explanation: "",
				points: 200,
				show: false,
				answered: false
			},
			{
				id: "1qxjj0ek1sccait",
				type: AnswerType.TEXT,
				answer: "A show about ponies and friendship. ",
				answerDe: "Eine Show über Ponys und Freundschaft.",
				question: "What is My Little Pony Friendship is Magic?",
				explanation: "",
				points: 400,
				show: false,
				answered: false
			...
			},
			{
				id: "1qxjj0ek1sccaj3",
				type: AnswerType.TEXT,
				answer: "An older show about a Samurai fighting to save the world from robots.",
				answerDe:
					"Eine ältere Show über einen Samurai, der darum kämpft, die Welt vor Robotern zu retten.",
				question: "What is Samurai Jack?",
				explanation: "",
				points: 1000,
				show: false,
				answered: false
	...
	},
	{
		...
		answers: [
			...
			},
			{
				...
				type: AnswerType.TEXT,
				answer:
					"This director brought the Lord of the Rings trilogy into the new millennium with an award-winning series of films based on these novels. ",
				answerDe:
